...
namespace Infoearth.Solution.MultiPointTile
{
    ...
    /// MySqlHelper操作类
    /// </summary>
    public class MySqlHelper : IDbProvider
    {
        /// <summary>
        /// 批量操作每批次记录数
        /// </summary>
        ...
        public MySqlHelper()
        {
            this.ConnectionString = ConfigurationManager.ConnectionStrings["DbBase"].ConnectionString;
        }
        ...
        {
            return ExecuteScalar<T>(ConnectionString, commandText);
        }
        ...
        {
            return ExecuteDataSet(ConnectionString, CommandType.Text, $"select * from {tableName} limit {(pageIndex - 1) * pageSize},{pageSize}");
        }
